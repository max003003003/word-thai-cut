...
//      ,/^(\d\d|\d)-(\d\d|\d)-(\d\d|\d)/gi
//      ,/^วัน(จันทร์|อังคาร|พุธ|พฤหัส|ศุกร์|เสาร์|อาทิตย์|แรก|พรุ่งนี้|มะรืน|)/gi
//      ,/^(จันทร์|อังคาร|พุธ|พฤหัส|ศุกร์|เสาร์|อาทิตย์|แรก|พรุ่งนี้|มะรืน|)/gi
//      ,/^(วัน|)(นี้|พรุ่งนี้|มะรืน)/gi
...
//           temp=temp.substr(tempb[mxi].length-1)          
//         }
//         else{
//           st+=temp[0]
//           temp=temp.substr(1)
...
//   //  console.log(resulRegex[mxi].index)
//   //    console.log(a)
     
//   //     a=a.replace(resulRegex[mxi][0],"")
    
//   //   out.push(resulRegex[mxi])
//   //   console.log(resulRegex[mxi])
...
//    /([1-2][0-9]|[0-9])(   |  | |)(มกรา|กุมภา|มีนา|เมษา|พฤษภา|มิถุนา|กรกฎา|สิงหา|กันยา|ตุลา|พฤศจิกา|ธันวา)/g]
...
//   //  console.log(answer)
//     answerForOriginal=answerForOriginal.filter(isSpace)
