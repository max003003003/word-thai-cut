...
//   return !(/^[0-9]*$/.test(v))
// }
// //for extract time from sentence input is raw text
// function splitTime(s) { 
//         console.log(s)
//    // let original=s.substr(0)
//       // var b = s.replace(/([1-2][0-9]|[0-9])(   |  | |)(โมง|นาฬิกา)(   |  | |)([0-5][0-9]|[0-9])(   |  | |)(นาที)/g,'')
//       // var c = b.replace(/([1-2][0-9]|[0-9])(   |  | |)โมง/g,'') 
//       // var d= c.replace(/[6-9][0-9](:|\.)([0-9][0-9]|[0-9])/g,'')
//       // var a = d.replace(/(1?[0-9]|2[0-3])(:|\.)[0-5][0-9]/g,'')   
//       let a = s
//       const regexPattern = [  
//         /^([1-2][0-9]|[0-9])(   |  | |)(โมง|นาฬิกา|ทุ่ม)(   |  | |)([0-5][0-9]|[0-9])(   |  | |)นาที/g 
//        ,/^([1-2][0-9]|[0-9])(   |  | |)(โมง|นาฬิกา|ทุ่ม)/g 
//        ,/^(บ่าย)(   |  | |)([1-5])(   |  | |)([0-5][0-9]|[0-9])(   |  | |)(นาที|)/g
//        ,/^(บ่าย)(   |  | |)([1-5])(   |  | |)(โมง)(   |  | |)([0-5][0-9]|[0-9])(   |  | |)(นาที|)/g  
//        ,/^(บ่าย|ตี)(   |  | |)([1-5])(   |  | |)(โมง)(   |  | |)/g     
//        ,/^(1?[0-9]|2[0-3])(:|\.)[0-5][0-9]/g
//        ,/^อีก(   |  | |)(\d\d\d|\d\d|\d)(   |  | |)(นาที|ชั่วโมง)/g  
//        ,/^เที่ยงคืน/g
//        ,/^เที่ยง/g
//        ,/^โมง/g    
//        ,/^ทุ่มนึง/gi
...
// //for extract date from  sentence  input is raw text 
...
//  return finalanss
// }
// function dayIneed(dayINeed)
// { 
//   console.log(dayINeed, moment().isoWeekday())
//     if (  dayINeed < moment().isoWeekday() ) { 
//     // then just give me this week's instance of that day
//     return moment().add(1,'week').isoWeekday(dayINeed) 
//   } else {
...
// function createTimeObject(data){  //data is [{ k:"" , s:""},{ k:"" , s:""}] ,k=keyword , s=string   
//   const rest = data.map((v)=>{
//                splitTime(v)
...
//             //   if(value.test(v.k))
//             //     {
//             //        console.log("output"+v.k)
//             //        console.log(dayIneed(index+1))
//             //        obj = {str:v, time:dayIneed(index+1) }
//             //     }
//             //  })   
//             //  return obj
//   })
...
// }
// // function splitTime(s){  //obj {k: s:}
// //       console.log("inside splitTime",s)
// // }
...
//  //   const input =  splitDate(s) 
//     const input2 = splitTime(s)
//     console.log(input2)
//      //createTimeObject(input)
//  }
...
// // console.log(splitWordWithPlusSign("12.00 ไปเที่ยวพัทยา ครับๆ 12 ก.ค. ไปไหนดีอ่ะ 13.23  ดินเนอร์  อีก 5 วัน บินไป ปารีส  วันจันทร์ 9   โมง "))